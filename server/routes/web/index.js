module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitle = ["重庆X王者荣耀，大乔白鹤梁神女皮肤今日上线", "写王者同人对话小说 赢万元现金大奖", "孙尚香-水果甜心优化海报票选活动开启", "老亚瑟的答疑时间: 孙尚香-水果甜心优化设计稿", "【狄仁杰封神榜】第53期 诈骗团伙落网 揭露新型诈骗套路", "7月3日全服不停机更新公告", "7月2日体验服停机更新公告", "7月2日战队赛参与次数异常说明公告", "7月1日体验服停机更新公告", "6月30日净化游戏环境声明及处罚公告", "石梁长在无谓浮沉，夏日炎炎好礼缤纷", "2020春夏赛事战令赛季战令礼包限时返场", "【燎原之心】与云缨畅游演武会活动开启公告", "【看KPL春决 赢至尊豪礼】活动开启公告", "S24新赛季来袭，新英雄云缨携礼登场", "全国大赛十大喝彩瞬间②：水韵江苏传承荣耀 英雄集结进军总决赛", "赢下喝彩，奔赴未来!第三届王者荣耀全国大赛小组赛今日开战!", "全国大赛十大喝彩瞬间①：金镶玉重现江湖 电竞赛场非遗手艺人登场", "2021年第三届王者荣耀全国大赛——带你重走全民记忆之路", "从普通玩家到职业选手需要走过多久的路?——全国大赛32强侧写"]
        const newsList = newsTitle.map(title => {
            let ramCats = cats.slice(0).sort((a, b) => Math.random() - 0.5)

            return {
                categories: ramCats.slice(0, 2),
                title
            }
        })
    ...
    router.get('/heroes/init', async (req, res) => {
        ...
        for (let cat of rawData) {
            ...
            console.log('cat.heroes', cat.heroes)
